import {calculatePayroll,type CalculationInput} from '../payroll.ts';
...
export function calculateHiring(input:HiringInput){
 ...
 const verdict=scenarios[0].profit>=0&&recoveryMonths!==null&&recoveryMonths<=6?'good':monthlyProfit>0&&recoveryMonths!==null&&recoveryMonths<=12?'conditional':'burden';
