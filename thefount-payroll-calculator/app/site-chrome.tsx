...
const menus=[{href:'/',label:'인건비 계산기',short:'계산기'},{href:'/startup',label:'개원자금',short:'개원자금'},{href:'/period',label:'재직기간',short:'재직기간'},{href:'/team',label:'팀 인건비',short:'팀 인건비'},{href:'/articles/durunuri',label:'두루누리',short:'두루누리'},{href:'/articles/net-contract',label:'네트제 계약',short:'네트제'}] as const;
